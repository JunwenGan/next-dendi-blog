...
const experiences: Experience[] = [
  {
    ...
    company: "Job Search Works",
    location: "Melbourne, Victoria",
    isRemote: false,
    role: "Software Developer",
    achievements: [
      "Developed core platform features enabling **AI-assisted resume, cover letter, and job application generation**.",
      "Integrated multiple **LLM APIs (OpenAI, Claude, Gemini)** for real-time personalised output.",
      "Delivered new features from concept to deployment in **2-week Agile sprints**, including daily stand-ups and sprint reviews.",
    ],
    techStack: [
      { name: "React" },
      { name: "TypeScript" },
